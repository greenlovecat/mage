...
public final class MurdersAtKarlovManorCommander extends ExpansionSet {
    ...
    private MurdersAtKarlovManorCommander() {
        ...
        cards.add(new SetCardInfo("Otherworldly Escort", 12, Rarity.COMMON, mage.cards.o.OtherworldlyEscort.class));
        cards.add(new SetCardInfo("Otherworldly Escort", 323, Rarity.COMMON, mage.cards.o.OtherworldlyEscort.class));
